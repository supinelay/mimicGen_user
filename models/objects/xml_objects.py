...
XML_ASSETS_BASE_PATH = "./models/assets"
...
class WoodBallObject(MujocoXMLObject):
    """
    Wood ball object.
    """
    def __init__(self, name):
        super().__init__(os.path.join(XML_ASSETS_BASE_PATH, "objects/wood_ball.xml"),
                         name=name, joints=None,
                         obj_type="all", duplicate_collision_geoms=True)


class AnyObject(MujocoXMLObject):
    """
    Any object.
    """
    def __init__(self, name):
